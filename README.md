...
<h3>Description :</h3> 
This is a webapp where you can attempt quiz and also post question.

👉[Click here](https://mernquizapp.onrender.com/) to check out the app.
<br/>

### 📃Features :

<ul>
<li>User can attempt quiz</li>
<li>User can also post question in the admin dashboard</li>
<li>Results of all users attempted quiz will be displayed</li>
</ul>
